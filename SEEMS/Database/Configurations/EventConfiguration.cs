...
namespace SEEMS.Database.Configurations
{
	public class EventConfiguration : IEntityTypeConfiguration<Event>
	{
		public void Configure( EntityTypeBuilder<Event> builder )
		{
			...
			var orgId = -3;
			//tech talk
			events.Add(new Event() { EventTitle = "Tech Talk with Harry Potter", EventDescription = "If Harry Potter is a developer", Active = true,  OrganizationId = orgId, EndDate = new DateTime(2022, 5, 12), ImageUrl = "http://media.vietq.vn/files/dinhthuy/phuongkhanh/harry-potter-cau-be-phu-thuy-tro-lai.jpg", IsPrivate = false, Location = "Hogwarts", StartDate = new DateTime(2022, 1, 1) });
			events.Add(new Event() { EventTitle = "Tech Talk with Cristiano Ronaldo", EventDescription = "If Ronaldo's passion is coding, not playing soccer", Active = true,   OrganizationId = orgId, EndDate = new DateTime(2022, 5, 12), ImageUrl = "https://cdn.justjared.com/wp-content/uploads/2013/12/ronaldo-toy/cristiano-ronaldo-one-toy-one-hope-charity-event-13.jpg", IsPrivate = false, Location = "Room 202 FPT", StartDate = new DateTime(2022, 1, 1) });
			events.Add(new Event() { EventTitle = "Tech Talk with Doctor Strange", EventDescription = "If Doctor Strange is a wizard and hacker at the same time ", Active = true,   OrganizationId = orgId, EndDate = new DateTime(2022, 5, 12), ImageUrl = "https://static.wikia.nocookie.net/marvelcinematicuniverse/images/b/b2/Doctor_Strange_MoM_Profile.jpeg/revision/latest?cb=20211229010907", IsPrivate = false, Location = "Wakanda", StartDate = new DateTime(2022, 1, 1) });
			events.Add(new Event() { EventTitle = "Tech Talk with Charlie Puth", EventDescription = "If Charlie Puth write song just for developers", Active = true,  OrganizationId = orgId, EndDate = new DateTime(2022, 5, 12), ImageUrl = "https://cuoifly.tuoitre.vn/820/0/ttc/r/2022/01/22/charlie-puth1-1642866050.jpeg", IsPrivate = false, Location = "Australia", StartDate = new DateTime(2022, 1, 1) });
			events.Add(new Event() { EventTitle = "Tech Talk with Monkey D. Luffy", EventDescription = "If Luffy become data scienctist after got One Piece", Active = true,  OrganizationId = orgId, EndDate = new DateTime(2022, 5, 12), ImageUrl = "https://gamek.mediacdn.vn/133514250583805952/2021/1/31/luffy-ace-merrry-16120917700922018336714.jpg", IsPrivate = false, Location = "Grand Line", StartDate = new DateTime(2022, 1, 1) });
