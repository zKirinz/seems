...
public class ReservationController : ControllerBase
{
    ...
    public async Task<IActionResult> Put([FromBody] ReservationForAttendanceReqDTO attendance)
    {
        try
        {
            ...
            if (reservation == null) return Ok(new Response(ResponseStatusEnum.Fail, "", "Invalid reservationId"));
    ...
    public async Task<IActionResult> Get(int id)
    {
        try
        {
            ...
            if (anEvent == null) return Ok(new Response(ResponseStatusEnum.Success, "", "Invalid eventId"));
    ...
    public async Task<IActionResult> Delete([FromBody] ReservationDTO reservationDTO)
    {
        try
        {
            ...
            if (events == null) return BadRequest(new Response(ResponseStatusEnum.Fail, "", "Invalid EventId"));
